<template>
    <div class="min-h-screen">
        <div v-if="book" class="container mx-auto px-4 py-4">
                    ...
                    <div class="col-span-2">
                        ...
                        <div class="py-4">
                            <div class="grid md:grid-cols-2">
                                ...
                                <div class="flex flex-col justify-center items-center md:mt-0 mt-72">
                                    <div class="mb-3">
                        ...
                        <div>
                            ...
                            <div v-if="!validate()">
                                <div class="px-6 py-5 pt-9">
                                    <button
                                        :disabled="validate"
                                        class="btn-next border w-full px-8 py-2 text-lg text-white font-light bg-[#c63f60] hover:text-white border-[#78343b] transition duration-500"
                                    >
                                        Next
                                    </button>
                                </div>
                        ...
                        <div>
                            <div>
                                ...
                                <div class="py-2">
                                    <p>{{ book.title }}</p>
                                    <p v-if="!validate()">Ngày đã chọn không hợp lệ</p>
                                    <p v-if="validate()">{{ format(date) }} at {{ booked.selectedTime }}</p>
                                </div>
                                <div class="py-4">
                                    <p>San Francisco</p>
                                    <p>Staff Member #1</p>
